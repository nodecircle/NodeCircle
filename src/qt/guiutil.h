...
/** Utility functions used by the NodeCircle Qt UI.
 */
namespace GUIUtil
{
...
// Render NodeCircle addresses in monospace font
...
// Parse "nodecircle:" URI into recipient object, return true on successful parsing
