...
VERSION=
commit=false
url=https://github.com/nodecircleproject/nodecircle
proc=2
mem=2000
lxc=true
...
Run this script from the directory containing the nodecircle, gitian-builder, gitian.sigs, and nodecircle-detached-sigs.
...
-u|--url	Specify the URL of the repository. Default is https://github.com/nodecircleproject/nodecircle
...
then
	# Make output folder
	mkdir -p "./nodecircle-binaries/${VERSION}"
	...
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit nodecircle=${COMMIT} --url nodecircle=${url} ../nodecircle/contrib/gitian-descriptors/gitian-linux.yml
	    ...
	    mv build/out/nodecircle-*.tar.gz build/out/src/nodecircle-*.tar.gz ../nodecircle-binaries/${VERSION}
	fi
	# Windows
	if [[ $windows = true ]]
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit nodecircle=${COMMIT} --url nodecircle=${url} ../nodecircle/contrib/gitian-descriptors/gitian-win.yml
	    ...
	    mv build/out/nodecircle-*.zip build/out/nodecircle-*.exe ../nodecircle-binaries/${VERSION}
	fi
	# Mac OSX
	if [[ $osx = true ]]
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit nodecircle=${COMMIT} --url nodecircle=${url} ../nodecircle/contrib/gitian-descriptors/gitian-osx.yml
	    ...
	    mv build/out/nodecircle-*.tar.gz build/out/nodecircle-*.dmg ../nodecircle-binaries/${VERSION}
	fi
	# AArch64
	if [[ $aarch64 = true ]]
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit nodecircle=${COMMIT} --url nodecircle=${url} ../nodecircle/contrib/gitian-descriptors/gitian-aarch64.yml
	    ./bin/gsign --signer $SIGNER --release ${VERSION}-aarch64 --destination ../gitian.sigs/ ../nodecircle/contrib/gitian-descriptors/gitian-aarch64.yml
	    mv build/out/nodecircle-*.tar.gz build/out/src/nodecircle-*.tar.gz ../nodecircle-binaries/${VERSION}
	fi
	popd || exit
...
then
	...
	then
	    ...
	    echo ""
	    ./bin/gbuild -i --commit signature=${COMMIT} ../nodecircle/contrib/gitian-descriptors/gitian-win-signer.yml
	    ...
	    mv build/out/nodecircle-*win64-setup.exe ../nodecircle-binaries/${VERSION}
	    mv build/out/nodecircle-*win32-setup.exe ../nodecircle-binaries/${VERSION}
	fi
	# Sign Mac OSX
	if [[ $osx = true ]]
	then
	    ...
	    echo ""
	    ./bin/gbuild -i --commit signature=${COMMIT} ../nodecircle/contrib/gitian-descriptors/gitian-osx-signer.yml
	    ...
	    mv build/out/nodecircle-osx-signed.dmg ../nodecircle-binaries/${VERSION}/nodecircle-${VERSION}-osx.dmg
	fi
	popd || exit
