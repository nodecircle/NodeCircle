Contributing to NodeCircle Core
============================

The NodeCircle Core project operates an open contributor model where anyone is
...
The following applies to code changes to the NodeCircle Core project, and is not to be
confused with overall NodeCircle Network Protocol consensus changes.

Whether a pull request is merged into NodeCircle Core rests with the project merge
...
Patches that change NodeCircle consensus rules are considerably more involved than
...
Where a patch set proposes to change the NodeCircle consensus, it must have been
...
The project leader is the release manager for each NodeCircle Core release.
