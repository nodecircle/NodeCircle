...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("NodeCircle Core nodecircle-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nodecircle-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nodecircle transaction") + "\n" +
                               "  nodecircle-tx [options] -create [commands]   " + _("Create hex-encoded nodecircle transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nodecircle transaction
