...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/nodecircle-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/nodecircle-cli.cpp \
           src/nodecircle-tx.cpp \
           src/nodecircle.cpp \
           src/db.cpp \
           ...
           src/qt/nodecircle.cpp \
           src/qt/nodecirclestrings.cpp \
...
RESOURCES += src/qt/nodecircle.qrc src/qt/nodecircle_locale.qrc

TRANSLATIONS += src/qt/locale/nodecircle_bg.ts \
                src/qt/locale/nodecircle_de.ts \
                src/qt/locale/nodecircle_en.ts \
                src/qt/locale/nodecircle_es.ts \
                src/qt/locale/nodecircle_fi.ts \
                src/qt/locale/nodecircle_fr.ts \
                src/qt/locale/nodecircle_it.ts \
                src/qt/locale/nodecircle_ja.ts \
                src/qt/locale/nodecircle_pl.ts \
                src/qt/locale/nodecircle_pt.ts \
                src/qt/locale/nodecircle_ru.ts \
                src/qt/locale/nodecircle_sk.ts \
                src/qt/locale/nodecircle_sv.ts \
                src/qt/locale/nodecircle_vi.ts \
                src/qt/locale/nodecircle_zh_CN.ts \
                src/qt/locale/nodecircle_zh_TW.ts
