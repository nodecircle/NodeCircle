...
bool OpenNetworkConnection(const CAddress& addrConnect, CSemanodecircleGrant* grantOutbound = NULL, const char* strDest = NULL, bool fOneShot = false);
...
public:
    ...
    CSemanodecircleGrant grantOutbound;
