                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("NodeCircle Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NodeCircle address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nodecircle: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zNCX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NodeCircle Core"), this);
    aboutAction->setStatusTip(tr("Show information about NodeCircle Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NodeCircle"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NodeCircle addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NodeCircle addresses"));
    ...
    openAction->setStatusTip(tr("Open a NodeCircle: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NodeCircle Core help message to get a list with possible NodeCircle command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NodeCircle Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NodeCircle network", "", count));
}
...
{
    QString strTitle = tr("NodeCircle Core"); // default title
