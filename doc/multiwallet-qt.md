...
In order to support loading of multiple wallets in nodecircle-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nodecircle.cpp.
...
Changes to nodecircle.cpp
----------------------
nodecircle.cpp is the entry point into nodecircle-qt, and as such, will require some minor modifications to provide hooks for
