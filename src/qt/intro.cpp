...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("NodeCircle Core"),
     ...
     * override -datadir in the nodecircle.conf file in the default data directory
     * (to be consistent with nodecircled behavior)
     */
    if (dataDir != getDefaultDataDirectory())
